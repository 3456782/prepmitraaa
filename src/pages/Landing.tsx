    ...
    <div className="overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 pt-20">
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-teal-electric/20 rounded-full blur-[120px]" />
          <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-teal-electric/10 rounded-full blur-[120px]" />
        </div>
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          >
            <span className="inline-block px-4 py-1.5 mb-6 text-sm font-bold tracking-wider text-teal-electric uppercase bg-teal-electric/10 rounded-full border border-teal-electric/20">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <Link 
                to="/auth" 
                className="group relative px-8 py-4 bg-teal-electric text-navy-deep font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 active:scale-95 shadow-lg shadow-teal-electric/25"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-teal-electric to-cyan-400 opacity-0 group-hover:opacity-100 transition-opacity" />
